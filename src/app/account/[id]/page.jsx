...
const accountpage = ({ user }) => {
  ...
  console.log(
    "🚀 ~ file: page.jsx:10 ~ accountpage ~ fromProfile:",
    fromProfile
  );
  const { id } = useParams();
    ...
    if (session?.user?.userid) {
      ...
      axios
        ...
        .then((response) => {
          ...
          setFormProfile({
            fristnameuser: response.data.fristnameuser,
            lastnameuser: response.data.lastnameuser,
            useraddress: response.data.useraddress,
            userzibId: response.data.userzibId,
  ...
  const loadData = async (id) => {
    await axios.get(api + "userdetail/" + id).then((res) => {
          ...
          <div className="col-10 col-lg-5">
            <form onSubmit={handleSubmit} action="#">
              ...
              <div className="flex items-center  w-44">
                <label
                  htmlFor="Avatar"
                  className="relative flex flex-col items-center justify-center w-full h-44 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
                >
                  {/* <img
                    src={imageUrl}
                  ...
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    ...
                    <p className="mb-2 text-sm text-gray-500 dark:text-gray-400">
                      <span className="font-semibold">อัพโหลดโปรไฟล์</span>{" "}
                    </p>
              ...
              <div className="grid md:grid-cols-2 md:gap-6 mt-4">
                <div className="relative z-0 w-full mb-6 group">
                  <input
                    ...
                    name="fristnameuser"
                    onChange={(e) => handleChange(e)}
                    defaultValue={fromProfile.fristnameuser}
                ...
                <div className="relative z-0 w-full mb-6 group">
                  <input
                    ...
                    name="lastnameuser"
                    onChange={(e) => handleChange(e)}
                    defaultValue={fromProfile.lastnameuser}
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" "
                    required
                  />
              ...
              <div className="relative z-0 w-full mb-6 group">
                <input
                  ...
                  id="useraddress"
                  onChange={(e) => handleChange(e)}
                  defaultValue={fromProfile.useraddress}
                  className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                  required
                />
              ...
              <div className="grid md:grid-cols-2 md:gap-6">
                <div className="relative z-0 w-full mb-6 group">
                  <input
                    ...
                    name="userzibId"
                    onChange={(e) => handleChange(e)}
                    defaultValue={fromProfile.userzibId}
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" "
                    required
                  />
                ...
                <div className="relative z-0 w-full mb-6 group">
                  <input
                    ...
                    name="province"
                    onChange={(e) => handleChange(e)}
                    defaultValue={fromProfile.province}
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" "
                    required
                  />
              ...
              <div className="grid md:grid-cols-2 md:gap-6">
                <div className="relative z-0 w-full mb-6 group">
                  <input
                    ...
                    name="userphone"
                    onChange={(e) => handleChange(e)}
                    defaultValue={fromProfile.userphone}
                    className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" "
                    required
                  />
