...
export default function Navbar() {
            ...
            {session?.user.roleId === "user" && (
              <div className="menu ">
                <ul>
                  ...
                  <a href={"/user/history/" + session.user.userid}>
                    <li>รายการ</li>
                  </a>
                  <a href="/contact">
                    <li>ติดต่อ</li>
            ...
            {session?.user.roleId === "admin" && (
              <div className="menu ">
                <ul>
                  ...
                  <a href={"/admin/history/" + session.user.userid}>
                    <li>รายการ</li>
                  </a>
                  <a href="/contact">
                    <li>ติดต่อ</li>
            ...
            {session?.user.roleId === "seller" && (
              <div className="menu ">
                <ul>
                  ...
                  <a href={"/seller/history/" + session.user.userid}>
                    <li>รายการ</li>
                  </a>
                  <a href="/contact">
                    <li>ติดต่อ</li>
              ...
              {session?.user.roleId === "user" && (
                <div className="flex items-center gap-3 md:gap-5 ml-80 ">
                  <Link
                    ...
                    href={
                      session?.user.roleId === "user"
                        ? "/user/beaseller/" + session.user.userid
                        : ""
                    }
  ...
  />
            ...
            <div className="sm:flex hidden  ">
              {session?.user.roleId === "seller" && (
                <div className="flex items-center gap-3 md:gap-5 -mr-72 ">
                  <Link
                    type="button"
                    href={
                      session?.user.roleId === "seller"
                        ? "/seller/addproduct/" + session?.user.userid
                        : "/"
                    }
                    className="btn btn-error  navprofile btnseller text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 "
                  >
              ...
              {session?.user.roleId === "admin" && (
                <div className="flex items-center gap-3 md:gap-5  ">
                  <Link
                    ...
                    href={
                      session?.user.roleId === "admin"
                        ? "/admin/addproduct/" + session?.user.userid
                        : "/"
                    }
                    className="btn btn-error   navprofile btnseller text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
                  >
  ...
  />
            ...
            {session?.user ? (
              <>
                <Menu as="div" className="mr-10">
                  <div className="flex">
                    <h6 className="mr-5 blue_gradient head_tex text-base text-center font-semibold">
                    ...
                    <Menu.Button className="avatar">
                      ...
                      {userAvatar ? (
                        <img
                          className="shadowavatar w-10 h-10 rounded-full flex object-cover"
                          src={userAvatar}
                        />
                      ) : (
                        <span>No Avatar</span>
                  ...
                  >
                    <Menu.Items className=" absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ">
                      ...
                      <Menu.Item>
                        {({ active }) => (
                          <a
                            href={"/password/" + session?.user.userid}
                            className={classNames(
                              active ? "bg-gray-100" : "",
                              "block px-4 py-2 text-sm text-gray-700"
                            )}
              ...
              <Link
                type="button"
                href="login"
                className="login-btn  text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2"
